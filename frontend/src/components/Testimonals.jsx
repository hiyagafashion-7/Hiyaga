...
import { testimonialsData } from "../assets/frontend_assets/assets";
...
const Testimonials = () => {
  ...
  return (
    <section className="relative my-10">
      <div className="relative z-10 max-w-screen-2xl px-0 md:px-4">
        <div className=" text-center">
          <Title text1={"Our"} text2={"Customers"} paragraph={"Customers love our footwear for its comfort, style, and durability. From casual sneakers to elegant shoes, every pair delivers unmatched quality. Join thousands of happy customers and step confidently!"}/>
        </div>
        <div className="" data-aos="fade-up">
          ...
          >
            {testimonialsData.map((item, idx) => (
              <div key={idx} className="flex flex-col mt-10 md:mx-5 mx-10 lg:mx-10 my-6 shadow-[rgba(17,_17,_26,_0.1)_0px_4px_12px] rounded-md">
                <div className="p-4">
                  <svg
                ...
                <figure>
                  <blockquote>
                    <p className="text-gray-800 text-lg px-4 py-1">
                      {item.quote}
                    </p>
                  </blockquote>
                  <div className="flex items-center gap-x-4 p-4 mt-6 bg-black rounded-md">
                    <img
                      src={item.avatar}
